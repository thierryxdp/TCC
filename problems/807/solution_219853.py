...
somento no final de cada frase. String; String->int"""
    ...
    if Quant_pontos_interrog>0:
        return Quant_pontos_ret + (Quant_pontos_exclam - 3*Quant_pontos_exclam) + Quant_pontos_interrog +Quant_pontos_finais
    else:
        return Quant_pontos_ret + Quant_pontos_interrog +Quant_pontos_finais