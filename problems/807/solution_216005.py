def conta_frases(paragrafo):
    '''Função que dado um paragrafo onde as frases são separadas pelas pomtuações:
    ponto final, ponto de esclamação, ponto de interrogação ou reticências retorna
