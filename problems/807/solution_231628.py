def conta_frases(frases):
    ...
    :return: int
    '''
    ponto_final = frases.replace("...", 'teste')
    ponto_exclamacao = ponto_final.replace("!", 'teste')
    ponto_interrogacao = ponto_exclamacao.replace("?", 'teste')
    reticencias = ponto_interrogacao.replace(".", 'teste')
