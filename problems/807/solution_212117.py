		...
		for i in range(len(texto)):
			if texto[0]=="." or texto[0]=="?"or texto[0]=="!":
				...
				if texto[i]=="." and texto[i+1]=="." and texto[i+2]==".":
					j+=1
				elif(texto[i]=="." and texto[i+1]!="!" and texto[i+1]!="?" and texto[i+1]!=".")or(texto[i]=="!" and texto[i+1]!="!" and texto[i+1]!="?" and texto[i+1]!=".")or(texto[i]=="?" and texto[i+1]!="!" and texto[i+1]!="?" and texto[i+1]!="."):
					k+=1
		return j+k