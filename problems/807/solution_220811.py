def conta_frases(frase):
    ...
    #nota-se que ao usar a funçao split no ultimo termo de
    # uma str, temos como resultado uma termo ' ' vazio
    #logo por tratarmos de frases, sempre teremos um split
    #no ultimo termo, entao podemos subtrair 1 
    return numeroDeFrases-1