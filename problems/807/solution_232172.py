def conta_frases(texto):
    '''inicialmente vi um entrave para apenas usar a função split, visto que se o texto tiver "...", a função não vai saber distinguir as reticências do ponto final. Por isso, criei esta condicional e usei a função split.
    '''
