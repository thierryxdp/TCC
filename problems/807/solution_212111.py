	...
	if(any(char.isdigit() for char in texto))==True:
		...
		for i in range(len(texto)):
			if texto[0]=="." or texto[0]=="?"or texto[0]=="!":
				...
				j+=1
			elif(texto[i]=="." and texto[i+1]!="!" and texto[i+1]!="?" and texto[i+3]!=".")or (texto[i]=="!" and texto[i+1]!="!" and texto[i+1]!="?" and texto[i+1]!=".") or (texto[i]=="?" and texto[i+1]!="!" and texto[i+1]!="?" and texto[i+1]!="."):
				k+=1
		return j+k