def conta_frases(texto):
    ...
    fatiamento5 = frases[reticencias:ponto]+'.' or frases[reticencias:exclamacao]+'!' or frases[reticencias:interrogacao]+'?' or frases[reticencias:reticencias]+'...'
    fatiamento6 = frases[ponto:]+'.' or frases[reticencias:]+'...' or frases[interrogacao:]+'?' or frases[exclamacao:]+'!'
    
    correcao2 = fatiamento2.replace('.','')
    correcao3 = fatiamento3.replace('!','')
    correcao4 = fatiamento4.replace('?','')

    numero_frases = (fatiamento1,fatiamento2,fatiamento3,fatiamento4,fatiamento5,fatiamento6)
