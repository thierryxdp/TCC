def conta_frases (frases):
    ...
    sep_fras1=str.count (frases,'.')
    sep_fras2=str.count (frases,'!')
    sep_fras3=str.count (frases,'?')
    sep_fras4=str.count (frases,'...')
    
    
    return sep_fras1+ sep_fras2+ sep_fras3+ sep_fras4 , frase2