def melhor_volta(A):
    '''Retorna a melhor volta de uma corrida (em que volta, qual tempo, e com qual corredor) recebendo uma matriz com o tempo de cada jogador em uma respectiva volta. list(list)->tuple. '''
    lista_tempo=[]
    lista_jogador=[]
