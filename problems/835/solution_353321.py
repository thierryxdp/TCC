def melhor_volta(x):
    ...
    return int(min('volta1','volta2','volta3','volta4','volta5','volta6','volta7','volta8','volta9','volta10').replace('volta','')), min(min('volta1'),min('volta2'),min('volta3'),min('volta4'),min('volta5'),min('volta6'),min('volta7'),min('volta8'),min('volta9'),min('volta10'))