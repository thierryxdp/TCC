def melhor_volta(matriz):
    ...
    for i in range(len(matriz)):
        menor_tempo_lista.append(min(matriz[i]))
        menor_volta_lista.append(matriz[i].index(min(matriz[i]))        
    menor_tempo_corredor = min(menor_tempo_lista)
    corredor = menor_tempo_lista.index(menor_tempo_corredor)
    index_menor_volta = menor_tempo_lista.index(menor_tempo_corredor)                                           
    volta_menor_tempo = menor_volta_lista[index_menor_volta]
