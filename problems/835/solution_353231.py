def melhor_volta(matriz):
    '''Essa função que recebe matriz de voltas com tempos e 
    verifica quem fez a melhor volta, com que tempo e em que
    volta, e retorna tupla com dados nessa ordem
    list--> tuple'''
    lista_tempos = []
    lista_voltas = []
