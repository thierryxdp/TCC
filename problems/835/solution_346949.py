def melhor_volta(voltas):
    ...
    elif list.index(lista,min(lista)) >9 and <=19:
        list.append(rapido,2)
    elif list.index(lista,min(lista)) >19 and <= 29:
        list.append(rapido,3)
    elif list.index(lista,min(lista)) >29 and <= 39:
        list.append(rapido,4)
    elif list.index(lista,min(lista)) >39 and <= 49:
        list.append(rapido,5)
    elif list.index(lista,min(lista)) >49 and <= 59:
