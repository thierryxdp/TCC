def melhor_volta(matriz):
    ...
    if 9<posicao_menor_tempo<=19:
        return tuple((2,min(comparador),posicao_menor_tempo+1-10))
    if 19<posicao_menor_tempo<=29:
        return tuple((3,min(comparador),posicao_menor_tempo+1-20))
    if 29<posicao_menor_tempo<=39:
        return tuple((4,min(comparador),posicao_menor_tempo+1-30))
    if 39<posicao_menor_tempo<=49:
        return tuple((5,min(comparador),posicao_menor_tempo+1-40))
    if 49<posicao_menor_tempo<=59:
        return tuple((6,min(comparador),posicao_menor_tempo+1-50))