def melhor_volta(matriz):
    '''retorna uma tupla contendo a melhor volta, qual piloto a realizou e em qual lap ele conseguiu tal tempo.
    matriz -> tuple'''
    lista_de_laps = []
    linha_atual = 0
    ...
    melhor_piloto = lista_de_laps.index(melhor_tempo)//10 + 1
    numero_da_volta = lista_de_laps.index(melhor_tempo)-(10*(melhor_piloto -1))+1
