def melhor_volta(matriz:list) -> tuple:
    """Essa função, dada uma matriz com os tempos de 6 corredores em 10 voltas
    em uma pista de Kart, determina de quem foi a melhor volta,
    ...
    for i in range(len(matriz)):
        ...
        #Definindo a volta do melhor tempo de cada corredor
