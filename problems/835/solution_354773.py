def melhor_volta(matriz):
    '''
    função que dada 10 voltas de uma corrida de Kart para cada 
    6 corredores, transforma uma matriz 6 x 10 e calcula de quem
    foi a melhor volta da prova contendo seu tempo e em qual volta.
    :param matriz: list 
    :return: tuple 
    '''
