def retira_pontuacao(frase):
    ...
    """Função que, dada uma frase, retorna a frase onde todos os caracteres(incluindo travessão, vírgula, dois pontos, ponto e vírgula, além da pontuação de encerramento de frase) tenham sido substituidos por espaço."""
