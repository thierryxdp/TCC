def carros(num_pessoas,capacidade_veiculo):
...
if capacidade_veiculo=5:
return num_pessoas//capacidade_veiculos
else capacidade_veiculo(n):
    return num_pessoas//capacidade_veiculo(n)