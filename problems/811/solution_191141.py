def colchao(medidas,H,L):
    ...
    diagonal_colchao = math.sqrt((medidas[2]**2)+(medidas[1]**2))
    if diagonal_porta > medidas[1] and L > medidas[1] and H <= medidas[2]and medidas[1] <= H and diagonal_colchao <= diagonal_porta:
        return True
    else:
        return False