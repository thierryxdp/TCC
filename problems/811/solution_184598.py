...
"""Retorna se é possível passar o colchao pela porta dado as medidas do colchao como o primeiro parametro, a altura da portacomo o segundo e a largura da porta como o ultimo parametro;
list,int,int->bool"""
