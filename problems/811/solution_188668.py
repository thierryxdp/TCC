def colchao(medidas,H,L):
    """Retorna true ou false dado o numero de medidas do colchao, altura e largura da porta.Retorna true se o colchao passar e false se nao passar. list,int,int->bool"""
