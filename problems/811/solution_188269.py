def colchao(medidas,H, L):
    ''' Função que compara as dimenções de um colchão e uma porta para saber se
    o colchão passa pela porta, retorna True caso passe e False caso contrário. Compara face a Face do paralelepípedo
