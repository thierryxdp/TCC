def colchao(medidas,H,L):
    ...
    if (largura_colchao<=L and comprimento_colchao<=H) or (largura_colchao<=L and altura_colchao<=H) or (altura_colchao<=L and comprimento_colchao<=H) or (largura_colchao<=H and comprimento_colchao<=largura_colchao):
        return True
    else:
        return False