def colchao(medidas, H, L):
    ...
    '''
    list medidas_ordenadas = medidas.sort(reverse = True)
    list tamanho_porta = [H, L].sort(reverse = True)
    resultado = tamanho_porta[0] < medidas_ordenadas[0] and tamanho_porta[1] < medidas_ordenadas[1]
    return resultado