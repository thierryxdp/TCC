...
def pontos_por_time(lst):
    ...
    o meu maior erro foi a ausência de vírgula separando as entradas do dicionário, e
    finalmente compreendi o uso de funções auxiliares dentro da principal
    """   
    return {lst[0][1] : resultado1(lst[0][2])[1] + resultado2(lst[1][2])[1]),     
            lst[0][0] : resultado1(lst[0][2])[0] + resultado2(lst[1][2])[0]}