...
def pontos_por_time(a):
    if pontos(a) + pontos1(a) == 0:
        return dict((a[0][0]), pontos(a) + pontos1(a), (a[0][1]), 6)
...
#pontos_por_time([['Botameiras','Paulo da gama', [4,0]], ['Paulo da gama','Botameiras',[2,5]]])
#pontos_por_time([['Botameiras','Paulo da gama', [3,3]], ['Paulo da gama','Botameiras',[4,4]]])