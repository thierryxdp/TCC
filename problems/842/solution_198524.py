def pontos_por_time(lista):
    ...
    if ida[2][0] == ida[2][1]:
        dicionario[ida[0]] = dicionario[ida[0]] +1 and dicionario[ida[1]] = dicionario[ida[1]] + 1
    
    if volta[2][0] > volta[2][1]:
        dicionario[ida[1]] = dicionario[ida[1] + 3
    if volta[2][0] == volta[2][1]:
        dicionario[ida[1]] = dicionario[ida[1]] + 1 and dicionario[ida[0]] = dicionario[ida[0]] + 1
