def pontos_por_time(lista):
    """
        ...
        <nome do time> -> <número total de pontos na fase>.
        Os pontos de um time na fase são calculados da seguinte 
        forma: em cada jogo, os times recebem três pontos por 
        vitória e um ponto por empate. Não são atribuídos pontos 
        para derrotas.
    """
    lista1 = lista[0]
    lista2 = lista[1]
