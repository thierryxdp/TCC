pontos_por_time(jogo1,jogo2):
    ...
    if gols_t1_jogo1>gols_t2_jogo1 and gols_t1_jogo2>gols_t2_jogo2:
        return pontos_time1=6 and pontos_time2=0
    elif gols_t1_jogo1<gols_t2_jogo1 and gols_t1_jogo2<gols_t2_jogo2:
        return pontos_time1=0 and pontos_time2=6
        ...
        return pontos_time1=4 and pontos_time2=1
    elif (gols_t1_jogo1>gols_t2_jogo1 and gols_t1_jogo2<gols_t2_jogo2) or (gols_t1_jogo1<gols_t2_jogo1 and gols_t1_jogo2>gols_t2_jogo2):
        return pontos_time1=3 and pontos_time2=3
    elif (gols_t1_jogo1<gols_t2_jogo1 and gols_t1_jogo2=gols_t2_jogo2) or (gols_t1_jogo1=gols_t2_jogo1 and gols_t1_jogo2<gols_t2_jogo2):
        return pontos_time1=1 and pontos_time2=4
    else:
        return pontos_time1=2 and pontos_time2=2