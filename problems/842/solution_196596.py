def pontos_por_time(lista):
    ...
    e um ponto por empate. Não são atribuídos pontos para derrotas. O total de pontos de uma fase é a soma de pontos
    dos dois jogos de uma fase"""
    lista1 = lista[0]
    lista2 = lista[1]
    placar1 = lista1[2]
    placar2 = lista2[2]
