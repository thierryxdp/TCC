def resultado1(placar1):
    if placar1[0]>placar1[1]:
        parcialA==3 and parcialB==0
    elif placar1[0]==placar1[1]:
    	parcialA==1 and parcialB==1
    else:
        parcialA==0 and parcialB==3
    
def resultado2(placar2):
    if placar2[0]>placar2[1]:
        finalB==3 and finalA==0
    elif placar2[0]==placar2[1]:
    	finalB==1 and finalA==1
    else:
        finalB==0 and finalA==3
...
def pontos_por_time(lst):
    ...
    """
tabA==parcialA + finalA and tabB==parcialB + finalB
    return tabela = {'time1' : int(tabA), 'time2' : int(tabB)}
