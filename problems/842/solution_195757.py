def pontos_por_time(jogos_da_fase):
    ...
    list -> dict"""
    list(jogos_da_fase[0])=jogo1
    list(jogos_da_fase[1])=jogo2
    list(jogo1[2])=resultado1
    list(jogo2[2])=resultado2
    pontosA=[0,0]
    pontosB=[0,0]
    ...
    return {jogo1[0]:(int(pontosA[0])+int(pontosA[1])),jogo1[1]:(int(pontosB[0])+int(pontosB[1]))}