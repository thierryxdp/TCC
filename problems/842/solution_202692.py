"""
A função recebe uma lista com dois itens, cada item também é uma lista e dentro dessa lista tem um item que também é lista

Assinatura: list[lista[str,str,[int,int]],lista[str,str,list[int,int]]] --> dict{str:int,str:int}
"""
