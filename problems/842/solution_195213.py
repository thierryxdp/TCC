def pontos_por_time(lista):
    ...
    f=gols1p2<gols2p2
        if a and d:
            pontuacao=pontuacao+{time1:3*2, time2:0}
        elif (a and f) or (c and d):
            pontuacao=pontuacao+{time1:3, time2:3}
        elif c and f:
            pontuacao=pontuacao+{time1:0, time2:3*2}
        elif (b and d) or (a and e):
            pontuacao=pontuacao+{time1:4, time2:1}
        elif (b and f) or (c and e):
            pontuacao=pontuacao+{time1:1, time2:4}
        elif b and e:
            pontuacao=pontuacao+{time1:2, time2:2}