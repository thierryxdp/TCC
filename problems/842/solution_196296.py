...
def pontos_por_time(jogos:list)->dict:
    ...
    if pontos_t2>pontos_t1:
        return {nome_t2:int(pontos_t2),nome_t1:int(pontos_t1)}or{nome_t1:int(pontos_t1), nome_t2:int(pontos_t2)}
    elif pontos_t1==pontos_t2:
        return {nome_t2:int(pontos_t2),nome_t1:int(pontos_t1)}or{nome_t1:int(pontos_t1), nome_t2:int(pontos_t2)}
    elif pontos_t1>pontos_t2:
        return {nome_t1:int(pontos_t1), nome_t2:int(pontos_t2)}or{nome_t2:int(pontos_t2),nome_t1:int(pontos_t1)}