def pontos_por_time(lista):
    ...
    if gols_time1_jogo2 > gols_time2_jogo2:
        pontos_time1 = pontos_time1 + 3
    if gols_time2_jogo1 > gols_time1_jogo1:
        pontos_time2 = pontos_time2 + 3
    if gols_time2_jogo2 > gols_time1_jogo2:
        pontos_time2 = pontos_time2 + 3
    if gols_time1_jogo1 == gols_time2_jogo1: #empate
        pontos_time1 = pontos_time1 + 1
        pontos_time2 = pontos_time2 +  1
    if gols_time1_jogo2 == gols_time2_jogo2: #empate
        pontos_time1 = pontos_time1 + 1
        pontos_time2 = pontos_time2 +  1
