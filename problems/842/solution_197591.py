def pontos_por_time(lista1):
    ...
    if pontostime2>pontostime1:
        diction={lista1[0][1]:pontostime2,lista1[0][0]:pontostime1}
    elif pontostime1>pontostime2 and:
        diction={lista1[0][0]:pontostime1,lista1[0][1]:pontostime2}
    else: 
        diction={lista1[0][1]:pontostime1,lista1[0][0]:pontostime2}