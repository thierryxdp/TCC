def pontos_por_time(lista):
    ...
    if (lista[0][2][0] > lista[0][2][1]) and (lista[1][2][0] < lista[1][2][1]):
        return dict.update({lista[0][0]: 6}, {lista[0][1]: 0})
    
    elif ((lista[0][2][0] > lista[0][2][1]) and (lista[1][2][0] == lista[1][2][1])) or ((lista[0][2][0] == lista[0][2][1]) and (lista[1][2][0] < lista[1][2][1])):
        return dict.update({lista[0][0]: 4}, {lista[0][1]: 1})
    
    elif (lista[0][2][0] < lista[0][2][1]) and (lista[1][2][0] > lista[1][2][1]):
        return dict.update({lista[0][1]: 6}, {lista[0][0]: 0})
    
    elif (lista[0][2][0] == lista[0][2][1]) and (lista[1][2][0] == lista[1][2][1]):
        return dict.update({lista[0][0]: 2}, {lista[0][1]: 2})
    
    elif ((lista[0][2][0] < lista[0][2][1]) and (lista[1][2][0] == lista[1][2][1])) or ((lista[0][2][0] == lista[0][2][1]) and (lista[1][2][0] < lista[1][2][1])):
        return dict.update({lista[0][0]: 1}, {lista[0][1]: 4})
    
    else:
        return dict.update({lista[0][1]: 3}, {lista[0][0]: 3})