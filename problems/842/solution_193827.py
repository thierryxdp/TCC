def pontos_por_time(confrontos):
    ...
    time1=confrontos[0]
    time2=confrontos[1]
    gols_t1_jogo1=confrontos[2][0]
    gols_t2_jogo1=confrontos[2][1]
    gols_t1_jogo2=confrontos[3][2][1]
    gols_t2_jogo2=confrontos[3][2][0]  
    confrontos=[[time1,time2,[gols_t1_jogo1, gols_t2_jogo2]],[time2,time1,[gols_t2_jogo2, gols_t1_jogo2]]]
