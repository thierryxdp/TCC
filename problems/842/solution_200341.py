#Tive que fazer enorme assim, pois não consegui pensar em uma função mais simples que entregasse o mesmo resultado
#Imagino que não havia necessidade de usar estruturas condicionais 
