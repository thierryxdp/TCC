...
#lista[lista[str,int,int],lista[str,int,int]--dicionário
	...
	if golsjogo1[0]>golsjogo1[1]:
		time2jogo1==time2jogo1+3
	elif golsjogo1[0]<golsjogo1[1]:
		time1jogo1==time1jogo1+3
	elif golsjogo1[0]==golsjogo1[1]:
		time1jogo1==time2jogo1+1 and timejogo1==time1jogo1+1
	
	if golsjogo2[0]>golsjogo2[1]:
		time2jogo2==3 and time1jogo2==0
	elif golsjogo2[0]<golsjogo2[1]:
		time1jogo2==3 and time2jogo2==0
	elif golsjogo2[0]==golsjogo2[1]:
		time1jogo2==1 and time2jogo2==1
