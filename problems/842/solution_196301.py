...
def pontos_por_time(jogos:list)->dict:
    ...
    if int(jogo1[2][0])+int(jogo2[2][1])>int(jogo1[2][1])+int(jogo2[2][0]):
        return {nome_t1:int(pontos_t1), nome_t2:int(pontos_t2)}
    elif int(jogo1[2][0])+int(jogo2[2][1])<int(jogo1[2][1])+int(jogo2[2][0]):
        return {nome_t2:int(pontos_t2), nome_t1:int(pontos_t1)}
    else:
        return {nome_t1:int(pontos_t1), nome_t2:int(pontos_t2)}