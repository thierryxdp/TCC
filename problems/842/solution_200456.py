def pontos_por_time(lista):
    '''Recebe uma lista com os nomes de times em partidas de futebol e seus respectivos placares e devolve um dicionario com o total de pontos nas duas rodadas;
    	list -> dictionary'''
    jogo1=lista[0]
    jogo2=lista[1]
    time1=lista[0][0]
