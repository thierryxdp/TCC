def pontos_por_time(lista):
    ...
    #time 1
    a=tupla_placar_time1[0]
    b=tupla_placar_time1[1]
    c=tupla_placar_time1[2]
    placar_pontos_time1=a+b+c
    
    #time 2
    placar_pontos_time2=()
    d=tupla_placar_time2[0]
    e=tupla_placar_time2[1]
    f=tupla_placar_time[2]
    placar_pontos_time2=d+e+f
