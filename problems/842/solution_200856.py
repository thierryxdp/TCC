def pontos_por_time(lista1,lista2):
                   ...
                   time1=lista1[0]
                   time2=lista1[1]
                   gol_time1_ida=lista1[2][0]
                   gol_time2_ida=lista1[2][1]
                   gol_time1_volta=lista2[2][0]
                   gol_time2_volta=lista2[2][1]
                   ...
                   dic1={lista1[0]:int(pontos1)}
                   dic2={lista1[1]:int(pontos2)}

                   return str({lista1[0]:str(pontos1)}) + str({lista1[1]:str(pontos2)})#Start your python function here