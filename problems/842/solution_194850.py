...
#Separei as listas para poder trabalhar melhor com elas durante o código
    lista_com_jogo_de_ida_e_jogo_de_volta[0]= jogo_de_ida
    lista_com_jogo_de_ida_e_jogo_de_volta[1]= jogo_de_volta
    ...
    if times2[0] == 'Flaminthians' and placar2[0]!=placar2[1]:
       ...
       pontos_cormengo= [pontos_cormengo[0] + 1]
       pontos_flaminthians= [pontos_flaminthians[0] +1]
    return {'Cormengo': pontos_cormengo, 'Flaminthians': pontos_flaminthians}#Start your python function here