...
def pontos_por_time(x):
    ...
    if golcorcasa1 > golflafora1:
        ...
        pontoscor1 = pontoscor1
        pontosfla1 = pontosfla1
    ...
    if golflacasa2>golcorfora2:
        ...
        pontoscor3 = pontoscor3
        pontosfla3 = pontosfla3
    ...
    if golcorfora2>golflacasa2:
        ...
        pontoscor4 = pontoscor4
        pontosfla4 = pontosfla4
    ...
    if golcorfora2 == golflacasa2:
        ...
        pontoscor6 = pontoscor6
        pontosfla6 = pontosfla6
