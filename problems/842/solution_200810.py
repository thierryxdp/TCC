def pontos_por_time(*jogo):
    ...
    gols_time1=gols_jogo_ida[0] and gols_jogo_volta[1]
    gols_time2=gols_jogo_ida[1] and gols_jogo_volta[0]
    ...
    if gols_jogo_ida[0] > gols_jogo_ida[1]\
    and gols_jogo_volta[0] < gols_jogo_volta[1]:
        return {time1:6,time2:0}
    elif gols_jogo_ida[0] < gols_jogo_ida[1]\
    and gols_jogo_volta[0] > gols_jogo_volta[1]:
        return {time2:6,time1:0}
    
    elif gols_jogo_ida[0] > gols_jogo_ida[1]\
    and gols_jogo_volta[0] == gols_jogo_volta[1]\
    or gols_jogo_ida[0] == gols_jogo_ida[1]\
    and gols_jogo_volta[0] < gols_jogo_volta[1]:
