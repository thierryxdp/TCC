def pontos_por_time(jogos):
    '''Após receber uma lista contendo duas listas referentes a dois jogos, contendo cada uma os nomes dos dois times competidores
    ...
    if (jogos[1][2][1]>jogos[1][2][0]):
      ...
      pontuacao1 = [pontuacao1[0]+1]
      pontuacao2 = [pontuacao2[0]+1]
    placar ={jogos[0][0]:pontuacao1[0],jogos[0][1]:pontuacao2[0])}
    return placar