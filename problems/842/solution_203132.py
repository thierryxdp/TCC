def pontos_por_time(listas_jogo):
    '''recebe uma lista de dois elementos onde cada elemento é uma lista,
    indicando o nome dos times e o número de gols, e retorna o número
    total de pontos dos times na fase'''
