def pontos_por_time(list(lista1),list(lista2)):
    ...
    if lista1[2][0]>lista1[2][1] and lista2[2][0]<lista2[2][1]:
	    return {lista1[0]:6,lista2[0]:0}
    elif lista1[2][0]>lista1[2][1] and lista2[2][0]==lista2[2][1]:
	    return {lista1[0]:4,lista2[0]:1}
    elif lista1[2][0]>lista1[2][1] and lista2[2][0]>lista2[2][1] or lista1[2][0]<lista1[2][1] and lista2[2][0]<lista2[2][1]:
	    return {lista1[0]:3,lista2[0]:3}
    elif lista1[2][0]<lista1[2][1] and lista2[2][0]>lista2[2][1]:
	    return {lista1[1]:0,lista2[0]:6}
    elif lista1[2][0]<lista1[2][1] and lista2[2][0]==lista2[2][1]:
	    return {lista1[0]:1,lista2[0]:4}
    else:
	    return {lista1[0]:2,lista2[0]:2}