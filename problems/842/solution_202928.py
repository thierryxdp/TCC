...
def pontos_por_time(jogo1, jogo2):
    ...
    Casos de teste: pontos_por_time(['fla','cor',[2,0]], ['cor','fla',[1,1]]) == {'fla' : 4, 'cor': 1}
    pontos_por_time(['real','liv',[4,0]], ['liv','real',[1,3]]) == {'real' : 6, 'liv' : 0} 
    pontos_por_time (['river','boca',[2,2]], ['boca','river',[0,0]]) == {'river' : 2, 'boca' : 2} '''
    t1 = jogo1[0]
    t2 = jogo1[1]
    gol1_t1 = jogo1[2][0]
    gol2_t1 = jogo1[2][1]
