def pontos_por_time(lista):
    '''funcao que dada uma lista contendo outras listas:
       ...
       O numero total é dado por 3* o numero de vitoria +
    ...
    if pontuacao1>pontua1:
            listavazia1=listavazia1+[pontuacao1*3]
    if pontuacao2> pontua2:
            listavazia1=listavazia1+[pontuacao2*3]
    if pontua1>pontuacao1:
            listavazia2=listavazia2+[pontua1*3]
    if pontua2>pontuacao2:
            listavazia2=listavazia2+[pontua2*3]
    return{time1:listavazia1,time2:listavazia2}