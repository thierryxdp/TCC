...
def pontos_por_time(x):
    ...
    posicaoL1 = sub_lista1[2]
    posicaoL2 = sub_lista2[2]
    
    prim_elem_PL1 = posicaoL1[0]
    seg_elem_PL1 = posicaoL1[1]
    
    prim_elem_PL2 = posicaoL2[0]
    seg_elem_PL2 = posicaoL2[1]
    ...
    return {L1:(ponto1 + ponto3), L2:(ponto2 + ponto4)}