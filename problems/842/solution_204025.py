...
def pontos_por_time(j1,j2):
    ...
    list,list->dict"""
#    pontos do time 1
    pontos_T1=pontos_jogo(j1[2][0],j1[2][1])+pontos_jogo(j2[2][1],j2[2][0])
#    pontos do time 2
    pontos_T2=pontos_jogo(j1[2][1],j1[2][0])+pontos_jogo(j2[2][0],j2[2][1])

    return {j1[0]:pontos_T1,j1[1]:pontos_T2}
print(pontos_por_time(['teste1','teste2',[0,2]],['teste2','teste1',[8,6]]))