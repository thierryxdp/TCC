#Start your python function heredef pontos_por_time(partidas):
    ...
    retorna um dicionario cujos mapeamentos s˜ao: nome do time e numero de pontos na fase. dic->dic. 
    p1 = partidas[0]
    p2 = partidas[1]
