...
pela lista x(Os pontos sao dados por: 3 a cada vitória, 
1 a cada empate, e 0 a cada derrota). Então, a função retorna um 
dicionário contendo o nome do time 1 e o total de pontos obtidos 
ao final dos dois jogos, e o mesmo para o time 2.
assinatura:
list-->dict
casos de teste:
