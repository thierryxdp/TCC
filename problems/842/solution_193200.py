def pontos_por_time(lista):
    ...
    if (pontos_t2_j1 > pontos_t1_j1) and (pontos_totais_t1 == pontos_totais_t2):
    	return {time2:pontos_totais_t2, time1:pontos_totais_t1}
    if (pontos_t1_j1 > pontos_t2_j1) and (pontos_totais_t1 == pontos_totais_t2):
        return {time1:pontos_totais_t1, time2: pontos_totais_t2}
    if pontos_totais_t1 > pontos_totais_t2:
        return {time1:pontos_totais_t1, time2: pontos_totais_t2}
    else:
        return {time2:pontos_totais_t2, time1: pontos_totais_t1}