def pontos_por_time(lista):
    ...
    if(pontos_ida[0]>pontos_ida[1]):#vitótia time 1
        return tupla_placar_time1=tupla_placar_time1+(3,) and tupla_placar_time2=tupla_placar_time2+(0,)
    elif(pontos_ida[0]=pontos_ida[1]):#empate
        return tupla_placar_time1=tupla_placar_time1+(1,) and tupla_placar_time2=tupla_placar_time2+(1,)
    else: #vitória time 2
        return tupla_placar_time2=tupla_placar_time2+(3,) and tupla_placar_time1=tupla_placar_time1+(0,)
