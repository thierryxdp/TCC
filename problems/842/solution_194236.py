def pontos_por_time(lista):
    ...
    lista->dicionario
 '''
    if lista[0][2][0] > lista [0][2][1] or lista [1][2][0]> lista[1][2][1]:
         return {lista [0][0]:6, lista [0][1]: 0} or {lista [0][1]:6, lista [0][0]: 0}
  
    
    elif lista[0][2][0] < lista [0][2][1] or lista [1][2][0]< lista[1][2][1]:
