...
def pontos_por_time(lista_fase):
    ...
    pontuacao = {}
    # Primeiro jogo
    if ( resultado(lista_fase[0][2]) == 0): # empate primeiro jogo
    ...
    # Segundo jogo
    if ( resultado(lista_fase[1][2]) == 0): # empate primeiro jogo
        pontuacao[lista_fase[1][0]] = pontuacao[lista_fase[1][0]] + 1
        pontuacao[lista_fase[1][1]] = pontuacao[lista_fase[1][0]] + 1
    elif ( resultado(lista_fase[1][2]) == 1): # vitoria time casa
        pontuacao[lista_fase[1][0]] += 3
        
    else: # vitoria time visitante
        pontuacao[lista_fase[1][1]] += 3
