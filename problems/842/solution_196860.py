def pontos_por_time (lista):
    ...
    if (pontos_campeo1<pontos_campeo2):
        return {lista_volta[0]:pontos_campeo2, lista_ida[0]: pontos_campeo1}
    elif (pontos_campeo1>pontos_campeo2)or(pontos_campeo1==pontos_campeo2)
