def pontos_por_time(Lista):
    ...
    b2=gvolta[0]
    b1=gvolta[1]
    if a1>a2 and b1>b2 and n_time1>n_time2:
        pont1=6
        pont2=0
    elif a1>a2 and b1==b2 or a1==a2 and b1>b2 and n_time1>n_time2:
        pont1=4
        pont2=1
    elif a1==a2 and b1==b2 and n_time1>n_time2:
        pont1=2
        pont2=2
    elif a1<a2 and b1>b2 or a1>a2 and b1<b2 and n_time1>n_time2:
        pont1=3
    ...
    return {n_time2:pont2,n_time1:pont1}