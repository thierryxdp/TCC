...
'''Declare uma lista de dois elemtnos, onde cada elmento é uma lista. A primeira lista deve conter os nomes dos times que disputam uma partida de futebol e a segunda lista o numero de gols de cada time'''
    jogoDaIda = listaX[0]
