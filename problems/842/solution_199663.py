def pontos_por_time (informacoes_dos_times):
    '''retorna o nome do time e a pontuação total
    list--> dict'''
    l1 = informacoes_dos_times[0]
    l2 = informacoes_dos_times[1]
   
    informacoes_dos_times = [l1, l2]
