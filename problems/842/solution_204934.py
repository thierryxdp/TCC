[07:33, 20/07/2022] Limoin Ufrj (João ): def pontos(x):
    gols_1 = x[0]
    gols_2 = x[1]
    if gols_1>gols_2:
        return [3,0]
...
[07:33, 20/07/2022] Limoin Ufrj (João ): pontos_jg1 = pontos([gols1jg1 , gols2jg1])
    ...
    return {time2:pontos_time2, time1:pontos_time1}#Start your python function here[07:33, 20/07/2022] Limoin Ufrj (João ): def pontos(x):
    gols_1 = x[0]
    gols_2 = x[1]
    if gols_1>gols_2:
        return [3,0]
