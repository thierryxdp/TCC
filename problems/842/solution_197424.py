def pontos_por_time(lista):
    ...
    if (lista[0][2][0] > lista[0][2][1]) and (lista[1][2][0] < lista[1][2][1]):
        dicio = {lista[0][0]: 6}
        dict.update(dicio, {lista[0][1]: 0})
        return dicio
    
    elif ((lista[0][2][0] > lista[0][2][1]) and (lista[1][2][0] == lista[1][2][1])) or ((lista[0][2][0] == lista[0][2][1]) and (lista[1][2][0] < lista[1][2][1])):
        dicio = {lista[0][0]: 4}
        dict.update(dicio, {lista[0][1]: 1})
        return dicio
    
    elif (lista[0][2][0] < lista[0][2][1]) and (lista[1][2][0] > lista[1][2][1]):
        dicio = {lista[0][1]: 6}
        dict.update(dicio, {lista[0][0]: 0})
        return dicio
    
    elif (lista[0][2][0] == lista[0][2][1]) and (lista[1][2][0] == lista[1][2][1]):
        dicio = {lista[0][0]: 2}
        dict.update(dicio, {lista[0][1]: 2})
        return dicio
    
    elif ((lista[0][2][0] < lista[0][2][1]) and (lista[1][2][0] == lista[1][2][1])) or ((lista[0][2][0] == lista[0][2][1]) and (lista[1][2][0] < lista[1][2][1])):
        dicio = {lista[0][0]: 1}
        dict.update(dicio, {lista[0][1]: 4})
        return dicio
    
    else:
        dicio = {lista[0][1]: 3}
        dict.update(dicio, {lista[0][0]: 3})
        return dicio