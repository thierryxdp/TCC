def pontos_por_time(lista):
    """
    Código que dado o placar dos jogos cálcula o saldo de pontos
    pela vitória e empate dos jogos de ida e volta.
    :list-->lista:
    :return-->dicionario:
    """
    jogo1=lista[0]
    ...
    #Condições Jogo2
    vitoria_time1_2=placar_jogo2[1]>placar_jogo2[0]
    vitoria_time2_2=placar_jogo2[0]>placar_jogo2[1]
