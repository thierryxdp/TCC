def pontos_por_time(lista):
    ...
    e retorna um dicionário cujos mapeamentos são: <nome do time> -> <número total de pontos na fase>
    Os pontos de um time na fase são calculados da seguinte forma: em cada jogo, os times recebem
