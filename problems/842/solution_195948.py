def pontos_por_time(jogos):
    ...
    result1={}
    result2={}
    pontos1={jogos[0][0]:result1[jogos[0][0]]+result2[jogos[0][0]]
            ,jogos[0][1]:result1[jogos[0][1]]+result2[jogos[0][1]]}
    pontos2={jogos[0][0]:result1[jogos[0][0]]+result2[jogos[0][1]]
             ,jogos[0][1]:result1[jogos[0][1]]+result2[jogos[0][0]]}
