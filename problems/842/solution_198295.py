#Anamaria, socorro... Não vai de jeito nenhum :[ 
#Já limpei os dados de navegação duas vezes e não vai. Não pude fazer mais nada.
...
#Separei as listas para poder trabalhar melhor com elas durante o código
    ...
    placar = {jogo_de_ida[0]: PontosTime1[0], jogo_de_ida[1]: PontosTime2[0]}
    return placar