def filtra_pares(a,b,c,d):
    if a%2==0 and (not b%2==0 and not c%2==0 and not d%2==0):
        ...
        return a,b
    elif c%2==0 and b%2==0 and (not a%2==0 and not d%2==0):
        return b,c
    elif c%2==0 and d%2==0 and (not a%2==0 and not b%2==0):
        return c,d
    elif a%2==0 and c%2==0 and (not b%2==0 and not d%2==0):
        return a,c
    elif a%2==0 and d%2==0 and (not c%2==0 and not b%2==0):
        return a,d
    elif d%2==0 and b%2==0 and (not c%2==0 and not a%2==0):
        return b,d