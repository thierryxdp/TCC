def filtra_pares(s):
    ...
    valor3 = s[2]
    valor4 = s[3]
    if (valor1,valor2,valor3%2) == 0:
        return valor1,valor2,valor3
    elif (valor1,valor2,valor4%2) == 0: 
        return valor1, valor2, valor4
    elif (valor1,valor3,valor4%2) == 0 :
        return valor1, valor3, valor4
    elif (valor2,valor3,valor4%2) == 0:
    ...
    elif valor1%2 == 0 and not (valor2,valor3,valor4%2) == 0:
        return valor1 
