def filtra_pares(numero1,numero2,numero3,numero4):
    ...
    if numero1[-1:] and numero2[-1:] and numero3[-1:] and numero4[-1:1] == 2 or 4 or 6 or 8:
        return (numero1,numero2,numero3,numero4)
    if numero[-1:1] and numero2[-1] and numero3[-1:] == 2 or 4 or 6 or 8:
        return (numero1,numero2,numero3," ")
    elif numero1[-1:1] and numero2 == 2 or 4 or 6 or 8:
