def filta_pares(tupla):
    ...
    elif tupla[0]%2 == 0 and tupla[1]%2 == 0 and tupla[2]% == 0:
        return (tupla[0], tupla[1], tupla[2])
    elif tupla[0]%2 == 0 and tupla[1]%2 == 0 and tupla[3]% == 0:
        return (tupla[0], tupla[1], tupla[3])
    elif tupla[0]%2 == 0 and tupla[2]%2 == 0 and tupla[3]% == 0:
        return (tupla[0], tupla[2], tupla[3])
    elif tupla[1]%2 == 0 and tupla[2]%2 == 0 and tupla[3]% == 0:
