def filtra_pares(elementos):
    ...
    if a%2 == 0 and b%2 == 0 and c%2 == 0 and d%2 == 0:
        ...
        return (b,)
    elif a%2 == 0 and (b%2 > 0 or b%2 < 0) and (c%2 > 0 or c%2 < 0) and d%2 == 0:
        return (a,d)
    elif a%2 == 0 and (b%2 > 0 or b%2 < 0) and c%2 == 0 and (d%2 > 0 or d%2 < 0):
        return (a,c)
    elif c%2 == 0 and (b%2 > 0 or b%2 < 0) and d%2 == 0 and (a%2 > 0 or a%2 < 0):
        return (c,d)
    elif d%2 == 0 and (c%2 > 0 or c%2 < 0) and b%2 == 0 and (a%2 > 0 or a%2 < 0):
        return (b,d)
    elif c%2 == 0 and (d%2 > 0 or d%2 < 0) and b%2 == 0 and (a%2 > 0 or a%2 < 0):
        return (b,c)
    elif d%2 == 0 and b%2 == 0 and c%2 == 0 and (a%2 > 0 or a%2 < 0):
        return (b,c,d)
    elif a%2 == 0 and d%2 == 0 and c%2 == 0 and (b%2 > 0 or b%2 < 0):
        return (a,c,d)