                            ...
                            if b%2==0 and d%2==0 and not(a%2==0 and c%2==0):
                                ...
                                if b%2==0 and c%2==0 and not(a%2==0 and d%2==0):
                                    ...
                                    if a%2==0 and b%2==0 and not(c%2==0 and d%2==0):
                                        ...
                                        if c%2==0 and d%2==0 and not(a%2==0 and b%2==0):
                                            return (c,d)
                                        else:
                                            if a%2==0  and not(b%2==0 and c%2==0 and d%2==0):
                                                return (a,)                            
                                            else:
                                                if b%2==0 and  not(a%2==0 and c%2==0 and d%2==0):
                                                    return (b,)
                                                else:
                                                    if c%2==0  and not(a%2==0 and b%2==0 and d%2==0):
                                                        return (c,)                            
                                                    else:
                                                        if d%2==0 and  not(a%2==0 and b%2==0 and c%2==0):
                                                            return (d,)