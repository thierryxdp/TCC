def filtra_pares(a,b,c,d):
    '''Filtra os números pares da tupla (a,b,c,d) e os coloca em uma
    nova tupla'''
    ...
    if a1==0 and b1==0 and c1==0 and d1==0:
        ...
        if not a1==0 and not b1==0 and not c1==0 and d1==0:
            return (d)
    '''não consegui fazer esse :(, acho que o código daria certo
    mas ele deve estar confundindo os valores de entrada ou algo
    do tipo'''