...
# t:tupla de 4 números, entrada1: primeiro número, entrada2: segundo número, entrada3: terceiro número, entrada4: quarto número
# tuple(float, float, float, float) -> tuple
def filtra_pares(t):
    entrada1, entrada2, entrada3, entrada4 = t
    a = entrada1 % 2
    b = entrada2 % 2
    c = entrada3 % 2
    d = entrada4 % 2
    ...
    if a != 0 and b != 0 and c !=0 and d !=0:
        ...
        return (entrada1, entrada2, entrada3, entrada4)#Start your python function here