def filtra_pares(s):
    ...
    valor3 = s[2]
    valor4 = s[3]
    if valor1%2 == 0 and (valor2,valor3,valor4%2) != 0:
        return valor1,
    elif valor2%2 == 0 and (valor1,valor3,valor4%2) != 0:
        return valor2,
    elif valor3%2 == 0 and (valor1,valor2,valor4%2) != 0:
        return valor3,
    elif valor4%2 == 0 and (valor1,valor2,valor3%2) != 0:
        return valor4,
