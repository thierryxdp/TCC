def filtra_pares(elementos):
    ...
    tuple -> tuple"""
    if elementos[0] % 2 == 0:
        if elementos[1] % 2 == 0 and elementos[2] != 0 and elementos[3] != 0:
            return (elementos[0], elementos[1])
        elif elementos[1] % 2 == 0 and elementos[2] % 2 == 0 and elementos[3] != 0:
        ...
        elif elementos[1] % 2 == 0 and elementos[2] == 0 and elementos[3] == 0:
        ...
        if elementos[2] % 2 == 0 and elementos[3] != 0:
