def colisao(ret1,ret2):
    ...
    if ((x_inf_esq1<=x_inf_esq2 and x_inf_esq2<=x_sup_dir1)or(x_inf_esq1<=x_sup_dir2 and x_sup_dir2<=x_sup+dir1))and((y_inf_esq1<=y_inf_esq2 and y_inf_esq2<=y_sup_dir2)or(y_inf_esq1<=y_sup_dir2 and y_sup_dir2<=y_sup_dir1)):
        return False
    else:
        return True