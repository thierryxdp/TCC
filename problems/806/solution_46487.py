...
# segunda etapa - calculo do resultado
    if ret1 == ret2:
        return True
    elif (x_sup_dir1, y_sup_dir1) > (x_inf_esq2, y_inf_esq2) and (x_sup_dir1, y_sup_dir1) < (x_sup_dir2, y_sup_dir2)and (x_inf_esq1, y_inf_esq1) < (x_sup_dir2, y_sup_dir2) and (x_inf_esq1, y_inf_esq1) > (x_inf_esq2, y_inf_esq2):
        return True
