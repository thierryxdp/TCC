...
def colisao(ret1,ret2):
    ...
    elif (intervaloy2[0] not in range(intervaloy1[0],intervaloy1[1])) and ((intervaloy2[1]) not in range(intervaloy1[0],intervaloy1[1])):
        return(False)
    elif (intervalox2[0] not in range(intervalox1[0],intervalox1[1])) and ((intervalox2[1]) not in range(intervalox1[0],intervalox1[1])):
        return(False)
