def colisao(ret1,ret2):
    '''a funcao colisao recebe duas tuplas com quatro valores inteiros cada uma, representando as 
     ...
     tuple, tuple --> bool'''
    #as informações serão estraídas em x_altura_lado(numero do retangulo) e y_altura_lado(numero do retangulo) para facilitar a visualização e não confundir as razões
    x_inf_esq1=()
    x_inf_esq2=()
    x_sup_dir1=()
    x_sup_dir2=()
