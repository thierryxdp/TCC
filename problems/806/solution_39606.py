...
# segunda etapa - calculo do resultado
    ...
    if (pontoInfEsq2[0] <= pontoInfEsq1[0] and (pontoInfEsq2[1] >= pontoInfEsq1[1])
        and (pontoSupEsq2[0] <= pontoSupDir1[0] and pontoSupEsq2[1] >= pontoSupDir1[1])
        or (pontoInfEsq2[0] >= pontoInfEsq1[0] and pontoInfEsq2[1] <= pontoInfEsq1[1])
        and (pontoSupDir2[0] >= pontoSupDir1[0] and pontoSupDir2[0] <= pontoSupDir1[1]):
        return True
