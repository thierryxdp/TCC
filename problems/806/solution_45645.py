...
#os 4 vértices dos retângulos
    retan1=(xi1,yi1)or(xs1,yi1)or(xi1,ys1)or(xs1,ys1)
    retan2=(xi2,yi2)or(xs2,yi2)or(xi2,ys2)or(xs2,ys2)

# segunda etapa - calculo do resultado
    if retan1==retan2:
        return True
    elif (xi1,yi1),(xs1,yi1),(xi1,ys1),(xs1,ys1)or(xi2,yi2),(xs2,yi2),(xi2,ys2),(xs2,ys2):
        return True
    else:
        return False