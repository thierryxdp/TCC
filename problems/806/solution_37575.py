...
def colisao(ret1,ret2):
    '''a funcao colisao recebe duas tuplas com quatro valores inteiros cada uma, representando as 
     ...
     tuple, tuple --> bool'''
    x_inf_esq1=int(ret1[0:1])
    y_inf_esq1=int(ret1[2:3])
    x_sup_dir1=int(ret1[4:5])
    y_sup_dir1=int(ret1[6:7])
    x_inf_esq2=int(ret2[0:1])
    y_inf_esq2=int(ret2[2:3])
    x_sup_dir2=int(ret2[4:5])
    y_sup_dir2=int(ret2[6:7])
