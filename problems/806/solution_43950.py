...
# segunda etapa - calculo do resultado
    ...
    elif ((x_inf_esq1, x_sup_dir1) in (x_inf_esq2, x_sup_dir2) and (y_inf_esq1, y_sup_dir1) in (y_inf_esq2, y_sup_dir2)):
        return True
    
    elif ((x_inf_esq2, x_sup_dir2) in (x_inf_esq1, x_sup_dir1) and (y_inf_esq2, y_sup_dir2) in (y_inf_esq1, y_sup_dir1)):
        return True
