def colisao(ret1,ret2):
    retangulo1_x = retangulo1[:1]
    retangulo1_y = retangulo1[2:3]
    retangulo1_width = retangulo1[4:5]
    retangulo1_height = retangulo1[6:7]

    retangulo2_x = retangulo2[:1]
    retangulo2_y = retangulo2[2:3]
