...
def colisao(ret1,ret2):
    ...
    tuple(ret1)
    tuple(ret2)
    x_inf_esq1=int(ret1[1])
    y_inf_esq1=int(ret1[3])
    x_sup_dir1=int(ret1[5])
    y_sup_dir1=int(ret1[7])
    x_inf_esq2=int(ret2[1])
    y_inf_esq2=int(ret2[3])
    x_sup_dir2=int(ret2[5])
    y_sup_dir2=int(ret2[7])
