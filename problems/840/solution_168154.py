def bolos(farinha,ovo,leite):
    ...
    if ((farinha/2)==1)<(ovo/3)==(leite/5)or((farinha/2)==1)<(ovo/3)!=(leite/5):
    	return int(farinha/2)
    elif ((ovo/3)==1)<(farinha/2)==(leite/5)or((ovo/3)==1)<(farinha/2)!=(leite/5):
    	return int(ovo/3)
    elif ((leite/5)==1)<(ovo/3)==(farinha/2)or((leite/5)==1)<(ovo/3)!=(farinha/2):
        return int(leite/5)
    else:
