def Trigo(trigo):
    'Dado o número de xícaras de farinha de trigo, retorna\
    a quantidade exata de xícaras que podem ser usadas na\
    receita.\
    int -> int'
    return trigo//2

def Ovos(ovos):
    'Dado o número de ovos, retorna a quantidade exata de\
    ovos que podem ser usadas na receita.\
    int -> int'
    return ovos//3
