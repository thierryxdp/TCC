def bolos(A, B, C):
    '''A função bolos aceita 3 floats ou integers como parâmetros, que representam as
    	quantidades de: xícaras de farinha, ovos e colheres de sopa
        de leite disponíveis, nesta ordem. Dados estes parâmetros, 
        a função retorna a variável quantidade, que representa quantos bolos podem ser feitos de
        acordo com a receita de bolo disponibilizada. Tal valor é sempre um integer,
