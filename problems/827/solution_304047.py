def divisores(numero):
    ...
    for numero_i in lista_dos_poss_div : #repete-se o comando nas linhas 8 e 9 para todos os elementos da lista_dos_poss_div
        if numero % numero_i == 0 : #checa-se se o numero_i é um divisor 
            Num_de_div = Num_de_div + 1  #se o número_i for um divisor, adiciona-se 1 ao número de divisores
    return Num_de_div #retorna-se o número de divisores