...
def acima_da_media(notas_total):
    '''dada uma lista com as notas dos alunos, retorna uma lsta ordenada com as notas que ficaram acima da média; list->list'''
    
    soma = sum(notas_total)
    quantidade = len(notas_total)
    
    media = soma/quantidade
    
    final = maiores(notas_total,media)
