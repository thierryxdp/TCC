...
def acima_da_media(lista):
    """Função que dada uma lista com as notas dos alunos, retorna uma nova lista, em ordem crescente, apenas com as notas que forem maiores que a média das notas contidas na lista original.
    entrada:([1,2,3,4,5,6]) saida:[5,6,7]
    entrada:([2,4,6,8]) saida:[6,8]
    entrada:([1,3,5,7,9]) saida:[5,7,9]
