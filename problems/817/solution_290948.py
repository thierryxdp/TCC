def maiores(lista_inteiros,n):
    """Funcao que recebe uma lista de números inteiros, um numero 
    inteiro n e retorna uma outra lista com todos os
    números da lista original que são maiores que n."""
