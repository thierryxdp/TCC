def acima_da_media(notas):
    """Dada uma lista com diversas notas de alunos, a função irá descobrir a média dessas notas,
    e os alunos que tiverem as notas acima desta média, terá a nota retornada em uma nova lista
    contendo apenas as notas maiores que a média
    list -> list"""
    ...
    if notas[8:numero_de_notas+1:100] > [media]:
        ...
        lista = lista
    if notas[9:numero_de_notas+1:100] > [media]:
        list.append(lista,notas[9])
    else:
        lista = lista
    lista.sort()
    return lista