def maiores(lista_numeros, n):
    ...
    quantia_de_n = list.count(lista_numeros, n)
    return lista_numeros[pos_de_n + quantia_de_n:]
def acima_da_media(lista):
    '''Função que dada uma lista com notas de alunos, retorne outra lista apenas com as notas
