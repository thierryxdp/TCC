def acima_da_media (lista):
    ...
    if len(lista)==1:
        return []
    elif lista [0]> media and len (lista)>0:
        return lista
    elif lista [1]>media and len (lista)==2:
        return lista [1:]
    elif lista [2]>media and len (lista)==3:
        return lista [2:]
    elif lista [3]>media and len(lista)==4:
        return lista[3:]
    elif lista [4]>media and len(lista)==5:
        return lista [4:]
    elif lista[5]>media and len(lista)==6:
        return lista [5:]
