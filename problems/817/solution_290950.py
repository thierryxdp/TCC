def maiores(lista_inteiros,n):
    """Funcao que recebe uma lista de numeros inteiros, um numero 
    inteiro n e retorna uma outra lista com todos os números da lista 
    original que são maiores que n."""
...
def acima_da_media(notas):
    """Função que, dada uma lista com as notas de alunos de uma turma,
