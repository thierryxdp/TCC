def acima_da_media(lista_de_notas):
    ...
    elif media <= 5 and A < 2 and par == True:
        list.sort(lista_de_notas)
        return lista_de_notas[A: ]
    elif media <= 5 and A < 2 and par == False:
        list.sort(lista_de_notas)
        del lista_de_notas[0]
        return lista_de_notas[A: ]

    elif media <= 5 and 5 in lista_de_notas and par == True :
        list.sort(lista_de_notas)
        return lista_de_notas[A: ]

    elif media <= 5 and 5 in lista_de_notas and par == False:
        list.sort(lista_de_notas)
        del lista_de_notas[0]
        return lista_de_notas[A: ]
    ...
    elif media < 5 and 5 not in lista_de_notas and par == True:
        list.sort(lista_de_notas)
        list.append(lista_de_notas, 5)
        list.sort(lista_de_notas)
        
        return lista_de_notas[-M: ]
    # fim menores que a media
