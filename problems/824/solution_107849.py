def uppCons(frase):
    """ A funçao uppCons recebe como entrada uma frase e retorna a frase com todas as suas consoantes em maiúsculas (e os demais caracteres exatamente como estavam na frase original).
        ...
        Testes:
            uppCons("Um homem que podia tudo!") = "UM HoMeM Que PoDia TuDo!"
            uppCons("São jóias viúvas, como eu, Capitu.") = "São JóiaS ViúVaS, CoMo eu, CaPiTu."
            uppCons("Ficou muito tempo com a cara virada para ele.") = "FiCou MuiTo TeMPo CoM a CaRa ViRaDa PaRa eLe."
