def total(lista, dicionario):
    '''função que recebe uma lista de comprar e um dicionario contendo o preço de cada produto e retorna
    o valor total dos intens da lista que estejam disponíveis na loja; list, dict->float'''
