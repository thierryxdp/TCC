def faltante(lista_de_numeros):
    '''retorna qual numero esta faltando na sequencia fornecida.
    list -> int'''
    ...
    while lista_correta[len(lista_correta)-1] != numero_final:
        ...
        numero += 1
    if numero_inicial == 1 and numero_inicial != numero_final:
        lista_correta.pop(0)
    ...
    for numero in lista_de_numeros:
        if lista_de_numeros[indice] != lista_correta[indice]:
            return lista_correta[indice]
        elif lista_de_numeros == lista_correta:
