def inverte(texto):
    '''Funcao que, dado um segmento de texto, o retorna com a ordem das palavras invertida. 
    Str -> Str.'''
    texto_copia = texto[:]
    ...
    FraseInversaComEspacos = str.join(' ', ordem_inversa)
    return FraseInversaComEspacos