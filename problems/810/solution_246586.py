def inverte(frases):
    if ',' in frases and '.' in frases and '-' in frases:
     ...
     frases2 = frases1[::-1]
    if ',' in frases and '.' in frases and '-' in frases and len(frases2) == 8:
    ...
    if ',' in frases and '.' in frases:
     ...
     frases1 = (str.split(frases0, ))
     frases2 = frases1[::-1]
     return str.lower(str(frases2[0]) + ' ' + str(frases2[1]) + ' ' + str(frases2[2])+' ' + str(frases2[3])+' ' +str(frases2[4])+' ' + str(frases2[5]))
    if '!' in frases:
     frases0 = (str.replace(frases , '!' , ' '))
     frases1 = (str.split(frases0, ))
     frases2 = frases1[::-1]
     return str.lower(str(frases2))