def inverte(far, oi=0):
    ...
    if len(str.split(oi)) == 3:
        ...
        return str.lower(str.split(oi)[-1::-1][0] + ' ' + str.split(oi)[-1::-1][1] + ' ' + str.split(oi)[-1::-1][2] + ' ' + str.split(oi)[-1::-1][3] + ' ' + str.split(oi)[-1::-1][4] + ' ' + str.split(oi)[-1::-1][5] + ' ' + str.split(oi)[-1::-1][6] + ' ' + str.split(oi)[-1::-1][7]+ ' ' + str.split(oi)[-1::-1][8] + ' ' + str.split(oi)[-1::-1][11])