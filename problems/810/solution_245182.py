def inverte (frase):
    '''Essa função dada uma frase como valor de entrada, calcula  e retorna uma frase onde os caracteres de pontuação são substituídos por espaço e depois a ordem da frase é invertida'''
    '''str->str'''
