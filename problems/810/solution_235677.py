...
def inverte(textinho):
    ...
    entao_da_pra_passar_mensagens_subliminares_nos_codigos = str.join(tudo_invertido_nessa_bosta)
    return entao_da_pra_passar_mensagens_subliminares_nos_codigos