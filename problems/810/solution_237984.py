def inverte(frase):
    ''' Retorna a frase dada na ordem inversa, sem maiúsculas, e sem pontuação.
    	str -> str
        
        Parameter:
        frase: Frase a ser invertida.
        
        Returns:
        A frase dada em ordem inversa, sem maiúsculas, e sem pontuação.
    '''
    lista1 = frase.split('-')
