def inverte(frase):
    '''funçao que inverte a frase sem pontuaçao e letra maiuscula'''
    for x in ".!?,;:-":
    ...
    if len(ultima) == 11:
        return ultima[0] + " " + ultima[1] + " " + ultima[2] + " " + ultima[3] + " " + ultima[4]+ " " + ultima[5] + " " + ultima[6] + " " + ultima[7] + " " + ultima[8] + " " + ultima[9] + " " + ultima[10]