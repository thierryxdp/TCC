def inverte(frase):
    ...
    frase_completa = str.lower(tira_interrogacao)
    frase_invertida = str.split(frase_completa)[::-1]
    return str.replace(str.replace(str.replace(str.replace(str(frase_invertida), ",", ""), "[", ""), "]", ""), "'", "")