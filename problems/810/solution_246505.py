def inverte(frases):
    ...
    if len(frases2) > 8:
     return  str.lower(str(frases2[0]) + ' ' + str(frases2[1]) + ' ' + str(frases2[2])+' ' + str(frases2[3])+' ' +str(frases2[4])+' ' + str(frases2[5])+ ' ' + str(frases2[6])+ ' ' + str(frases2[7])+' '+ str(frases2[8])+' '+ str(frases2[9]) + ' ' + str(frases2[10])+' ' + str(frases2[11])+' ' +str(frases2[12]))
    else:
