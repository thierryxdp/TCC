def retira_pontuacao(frase):
    """Faça uma função chamada inverte que dada uma frase retorne uma outra frase 
    que contenha as mesmas palavras da frase de entrada na ordem inversa, sem letras maiúsculas, e sem a pontuação."""
