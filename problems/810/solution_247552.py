def retira_pontuacao(frase):
    ''' dada uma frase de entrada, substitui todos os caracteres de pontuação por uma string vazia ou por espaço quando for travessao nessa frase str->str '''
...
def inverte(frase):
    ...
    return str.replace(str.join(' ',str.split(str.lower(retira_pontuacao(frase)),' ')[::-1]),' ','',1)