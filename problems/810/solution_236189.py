...
def inverte(s):
    '''Função que recebe uma frase e retorna as mesmas palavras da frase de entrada na ordem inversa, sem pontuação ou letras maiúsculas; str->str'''
    s1=retira_pontuacao(s)
    s2=str.split(s1,' ')
    s4=s2[::-1]
    s5=str.join(' ',s4)
    s6=str.lower(s5)
